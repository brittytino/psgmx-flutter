...
('25mx201@psgtech.ac.in', 'Anuvarshini', '25MX201', 'G1', 'T17', '2004-05-11', 'Anu_varshini_11', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": true, "isPlacementRep": false}'),
...
('25mx304@psgtech.ac.in', 'Aravindh Kannan M S', '25MX304', 'G2', 'T07', '2003-05-24', 'aravindh245', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx306@psgtech.ac.in', 'Chittesh', '25MX306', 'G2', 'T06', '2004-03-01', 'chittesh', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
('25mx307@psgtech.ac.in', 'Darunya Sri M', '25MX307', 'G2', 'T19', '2004-09-11', 'Darunya_Sri', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
('25mx308@psgtech.ac.in', 'Dayananda J', '25MX308', 'G2', 'T02', '2005-05-26', 'DayanandaJ', '{"isStudent": true, "isTeamLeader": true, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx315@psgtech.ac.in', 'Induja E', '25MX315', 'G2', 'T02', '2004-12-23', 'indujaee', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx317@psgtech.ac.in', 'Janani T G', '25MX317', 'G2', 'T16', '2004-10-21', 'u00mGgJrMX', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx326@psgtech.ac.in', 'Meyappan R', '25MX326', 'G2', 'T19', '2004-06-06', 'Meyappan_R', '{"isStudent": true, "isTeamLeader": true, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx330@psgtech.ac.in', 'Monish P', '25MX330', 'G2', 'T14', '2005-02-25', '9AIYYQsbfu', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx332@psgtech.ac.in', 'Muthu Sailappan', '25MX332', 'G2', 'T01', '2004-05-22', 'muthusailappan', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx335@psgtech.ac.in', 'Naveen Pranab T', '25MX335', 'G2', 'T21', '2004-06-03', 'Naveenpranab', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx337@psgtech.ac.in', 'Nithyashree C', '25MX337', 'G2', 'T19', '2004-06-29', 'Nithyashree_C', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx343@psgtech.ac.in', 'Sabarish P', '25MX343', 'G2', 'T20', '2004-08-19', 'SABARISH_P', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
('25mx344@psgtech.ac.in', 'Satya Pramodh R', '25MX344', 'G2', 'T17', '2004-07-19', 'SATYA_PRAMODH', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx346@psgtech.ac.in', 'Siddarth M R', '25MX346', 'G2', 'T17', '2004-09-12', 'sidddarthvasi2604', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
('25mx347@psgtech.ac.in', 'Sivapradeesh M', '25MX347', 'G2', 'T11', '2003-03-16', 'Sivapradeesh_M', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx351@psgtech.ac.in', 'Suriya C S', '25MX351', 'G2', 'T06', '2004-09-29', 'suriyaCSD', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": false}'),
...
('25mx354@psgtech.ac.in', 'Tino Britty J', '25MX354', 'G2', 'T18', '2004-07-08', 'britty04', '{"isStudent": true, "isTeamLeader": false, "isCoordinator": false, "isPlacementRep": true}'),
